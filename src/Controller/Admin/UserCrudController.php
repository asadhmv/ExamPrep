...
class UserCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('roles', 'Roles')->setChoices(['Admin' => 'ROLE_ADMIN', 'Etudiant'=>'ROLE_ETUDIANT'])->allowMultipleChoices()->setColumns(6),
            ...
            IdField::new('studnt_id')->onlyOnIndex()->setColumns(6),
