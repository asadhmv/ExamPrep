...
class get_ZenstruckFoundry_ConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setModelFactoryManager(new \Zenstruck\Foundry\ModelFactoryManager(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Factory\\ModuleFactory'] ??= new \App\Factory\ModuleFactory());
            yield 1 => ($container->privates['App\\Factory\\QuizFactory'] ??= new \App\Factory\QuizFactory());
            yield 2 => ($container->privates['App\\Factory\\QuizmarkFactory'] ??= new \App\Factory\QuizmarkFactory());
            yield 3 => ($container->privates['App\\Factory\\RessourcesFactory'] ??= new \App\Factory\RessourcesFactory());
            yield 4 => ($container->privates['App\\Factory\\StudentFactory'] ??= new \App\Factory\StudentFactory());
            yield 5 => ($container->privates['App\\Factory\\SubjectFactory'] ??= new \App\Factory\SubjectFactory());
            yield 6 => ($container->privates['App\\Factory\\UserFactory'] ??= new \App\Factory\UserFactory());
        }, 7)));
